    ...
    <div
      ...
      <div className="text-white max-w-max">
        <main className="text-center">
          ...
          <div
            className="mt-6 sm:mt-8 sm:flex sm:justify-center sm:items-center">
            <div className="sm:border-l sm:border-gray-200 sm:pl-6">
              <h1
                className="text-4xl font-extrabold text-gray-200 tracking-tight sm:text-5xl">{t("title")}</h1>
              <p className="mt-3 text-base text-gray-300">{t("description")}</p>
            </div>
            <div
              className="mt-8 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              <Link href="/"
                    className="button text-blue-600">{t("common:back-to-home")}</Link>
            </div>
          </div>
        </main>
      </div>
